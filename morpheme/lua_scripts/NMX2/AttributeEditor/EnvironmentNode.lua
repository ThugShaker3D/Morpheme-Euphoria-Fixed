...
local attributeGroups, errorString = scriptManager:createCallback(
  ...
  [[
    validAttributes:push_back{
      nmx.String.new('Environment Attributes'),
      nmx.String.new('Gravity') }
  ]]
)

-- Unregister any previous callbacks
callbackManager:unRegisterAttributeGroupsCallback(app:lookupTypeId("EnvironmentNode"))
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(app:lookupTypeId("EnvironmentNode"), attributeGroups)
