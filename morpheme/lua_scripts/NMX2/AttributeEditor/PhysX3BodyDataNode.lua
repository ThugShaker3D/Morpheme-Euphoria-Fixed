...
local bodyDataAttributeGroups = scriptManager:createCallback(
  ...
  [[
    local attrs = {
      ...
      'InertiaSphericalisation',
      'NonArticulationSleepThreshold',
      'MaxContactOffsetIncrease',
    }
...
callbackManager:unRegisterAttributeGroupsCallback("PhysX3BodyDataNode")
-- Register the new callback
callbackManager:registerAttributeGroupsCallback("PhysX3BodyDataNode", bodyDataAttributeGroups)