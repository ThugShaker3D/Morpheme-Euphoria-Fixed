...
callbackManager:unRegisterAttributeGroupsCallback(nmx.PosQuatTransformNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.PosQuatTransformNode.ClassTypeId(), attributeGroups)
