...
callbackManager:unRegisterAttributeGroupsCallback("PhysicsTwistSwingNode")
-- Register the new callback
callbackManager:registerAttributeGroupsCallback("PhysicsTwistSwingNode", attributeGroups)
