...
callbackManager:unRegisterAttributeGroupsCallback(nmx.DiffuseTexturedMaterialNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.DiffuseTexturedMaterialNode.ClassTypeId(), attributeGroups)
