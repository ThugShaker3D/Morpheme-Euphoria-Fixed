...
registerBehaviourStateMachine("BehaviourStateMachine",
{
    displayName = "Behaviour State Machine",
    helptext = "Create a Behaviour State Machine",
    group = "Containers",
    image = "BehaviourStateMachine.png",
    ...
    serialize = function(node, stream)
      ...
      while not isValid(defaultState) and smIndex <= childCount do
		...
		-- if childType == "BehaviourBlendTree" ? this string pop up anywhere in morphemeConnectCore
        if childType == "BlendTree" or childType == "StateMachine" or childType == "BehaviourStateMachine" then
...
------------------------------------------------------------------------------------------------------------------------
-- BehaviourStateMachine custom editor
------------------------------------------------------------------------------------------------------------------------
