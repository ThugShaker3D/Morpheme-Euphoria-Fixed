...
local attributeGroups, errorString = scriptManager:createCallback(
  ...
  --
  [[
  -- Dont display any attributes
  ]]
)

-- Unregister any previous callbacks
callbackManager:unRegisterAttributeGroupsCallback(nmx.CollisionSetNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.CollisionSetNode.ClassTypeId(), attributeGroups)
