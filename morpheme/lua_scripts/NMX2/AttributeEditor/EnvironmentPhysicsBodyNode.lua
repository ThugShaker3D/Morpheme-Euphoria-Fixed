...
callbackManager:unRegisterAttributeGroupsCallback(nmx.EnvironmentPhysicsBodyNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.EnvironmentPhysicsBodyNode.ClassTypeId(), attributeGroups)
