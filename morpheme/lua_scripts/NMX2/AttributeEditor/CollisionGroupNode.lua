...
local attributeGroups, errorString = scriptManager:createCallback(
  ...
  validAttributes:push_back{
    nmx.String.new('Collision group Attributes'),
...
callbackManager:unRegisterAttributeGroupsCallback(nmx.CollisionGroupNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.CollisionGroupNode.ClassTypeId(), attributeGroups)
