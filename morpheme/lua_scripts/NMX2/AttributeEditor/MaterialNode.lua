...
callbackManager:unRegisterAttributeGroupsCallback(nmx.MaterialNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.MaterialNode.ClassTypeId(), attributeGroups)
