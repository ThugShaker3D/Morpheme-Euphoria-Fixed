...
local attributeGroups, errorString = scriptManager:createCallback(
  ...
  [[
    validAttributes:push_back{
       nmx.String.new('Translation'),
       nmx.String.new('Translation') }

    validAttributes:push_back{
      nmx.String.new('Rotation'),
      nmx.String.new('RotationX'),
      nmx.String.new('RotationY'),
      nmx.String.new('RotationZ'),
      nmx.String.new('RotationOrder') }

  ]]
)

-- Unregister any previous callbacks
callbackManager:unRegisterAttributeGroupsCallback(nmx.TransformNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.TransformNode.ClassTypeId(), attributeGroups)
