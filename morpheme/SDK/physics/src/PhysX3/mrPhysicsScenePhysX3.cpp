  ...
  physx::PxU32 NMP_UNUSED(constantBlockSize))
{
  ...
  pairFlags |= physx::PxPairFlag::eDETECT_DISCRETE_CONTACT;//salsatobias: new physx shit
...
//----------------------------------------------------------------------------------------------------------------------
physx::PxQueryHitType::Enum MorphemePhysX3QueryFilterCallback::preFilter(
  ...
  physx::PxHitFlags& hitFlags)
{
  ...
  (void)hitFlags; // this is the filterFlags passed into raycastSingle
...
//----------------------------------------------------------------------------------------------------------------------
physx::PxQueryHitType::Enum MorphemePhysX3QueryFilterCallback::postFilter(
  const physx::PxFilterData& NMP_UNUSED(filterData), 
