...
local attributeGroups, errorString = scriptManager:createCallback(
  ...
  [[
    validAttributes:push_back{
      nmx.String.new('Sphere Attributes'),
      nmx.String.new('Radius') }
  ]]
)

-- Unregister any previous callbacks
callbackManager:unRegisterAttributeGroupsCallback(nmx.SphereNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.SphereNode.ClassTypeId(), attributeGroups)
