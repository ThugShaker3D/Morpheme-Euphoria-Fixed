...
callbackManager:unRegisterAttributeGroupsCallback(nmx.BodySetNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.BodySetNode.ClassTypeId(), attributeGroups)
