...
callbackManager:unRegisterAttributeGroupsCallback(nmx.KinematicTwistSwingNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.KinematicTwistSwingNode.ClassTypeId(), attributeGroups)
