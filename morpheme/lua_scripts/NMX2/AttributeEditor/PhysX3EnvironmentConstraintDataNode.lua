...
callbackManager:unRegisterAttributeGroupsCallback("PhysX3EnvironmentConstraintDataNode")
-- Register the new callback
callbackManager:registerAttributeGroupsCallback("PhysX3EnvironmentConstraintDataNode", attributeGroups)