...
local attributeGroups, errorString = scriptManager:createCallback(
  ...
  [[
    validAttributes:push_back{
      nmx.String.new('Box Attributes'),
      nmx.String.new('Width'),
      nmx.String.new('Height'),
      nmx.String.new('Depth') }
  ]]
)

-- Unregister any previous callbacks
callbackManager:unRegisterAttributeGroupsCallback(nmx.BoxNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.BoxNode.ClassTypeId(), attributeGroups)
