...
callbackManager:unRegisterAttributeGroupsCallback("PhysX3VolumeDataNode")
-- Register the new callback
callbackManager:registerAttributeGroupsCallback("PhysX3VolumeDataNode", volumeDataAttributeGroups)