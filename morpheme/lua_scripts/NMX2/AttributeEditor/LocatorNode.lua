...
local attributeGroups, errorString = scriptManager:createCallback(
  ...
  [[
    validAttributes:push_back{
      nmx.String.new('Locator Settings'),
      nmx.String.new('Colour'),
      nmx.String.new('DisplayType'),
      nmx.String.new('Size') }
  ]]
)

-- Unregister any previous callbacks
callbackManager:unRegisterAttributeGroupsCallback(nmx.LocatorNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.LocatorNode.ClassTypeId(), attributeGroups)
