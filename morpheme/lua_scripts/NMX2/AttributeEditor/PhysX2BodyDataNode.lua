...
callbackManager:unRegisterAttributeGroupsCallback("PhysX2BodyDataNode")
-- Register the new callback
callbackManager:registerAttributeGroupsCallback("PhysX2BodyDataNode", bodyDataAttributeGroups)