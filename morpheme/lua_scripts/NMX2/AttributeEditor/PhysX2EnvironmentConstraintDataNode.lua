...
callbackManager:unRegisterAttributeGroupsCallback("PhysX2EnvironmentConstraintDataNode")
-- Register the new callback
callbackManager:registerAttributeGroupsCallback("PhysX2EnvironmentConstraintDataNode", attributeGroups)