...
local attributeGroups, errorString = scriptManager:createCallback(
  ...
  [[
    ...
    'Mass Attributes',
    'CenterOfMass',
    'InertiaTensorRotationX',
    'InertiaTensorRotationY',
...
callbackManager:unRegisterAttributeGroupsCallback(nmx.PhysicsMassPropertiesNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.PhysicsMassPropertiesNode.ClassTypeId(), attributeGroups)
