...
local volumeDataAttributeGroups = scriptManager:createCallback(
...
callbackManager:unRegisterAttributeGroupsCallback("PhysX2VolumeDataNode")
-- Register the new callback
callbackManager:registerAttributeGroupsCallback("PhysX2VolumeDataNode", volumeDataAttributeGroups)