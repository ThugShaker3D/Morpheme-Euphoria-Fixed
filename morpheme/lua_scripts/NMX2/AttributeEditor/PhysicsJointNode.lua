...
callbackManager:unRegisterAttributeGroupsCallback(nmx.PhysicsJointNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.PhysicsJointNode.ClassTypeId(), attributeGroups)
