...
callbackManager:unRegisterAttributeGroupsCallback(nmx.EnvironmentPhysicsConstraintNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.EnvironmentPhysicsConstraintNode.ClassTypeId(), attributeGroups)
