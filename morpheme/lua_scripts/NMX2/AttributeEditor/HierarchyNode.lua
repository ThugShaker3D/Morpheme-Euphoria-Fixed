...
callbackManager:unRegisterAttributeGroupsCallback(app:lookupTypeId('HierarchyNode'))
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(app:lookupTypeId('HierarchyNode'), attributeGroups)
