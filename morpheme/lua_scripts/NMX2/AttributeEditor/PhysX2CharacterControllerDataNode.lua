...
callbackManager:unRegisterAttributeGroupsCallback("PhysX2CharacterControllerDataNode")
-- Register the new callback
callbackManager:registerAttributeGroupsCallback("PhysX2CharacterControllerDataNode", attributeGroups)