...
callbackManager:unRegisterAttributeGroupsCallback(nmx.MeshNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.MeshNode.ClassTypeId(), attributeGroups)
