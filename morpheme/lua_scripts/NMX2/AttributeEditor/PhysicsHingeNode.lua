...
callbackManager:unRegisterAttributeGroupsCallback(nmx.PhysicsHingeNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.PhysicsHingeNode.ClassTypeId(), attributeGroups)
