...
local attributeGroups, errorString = scriptManager:createCallback(
  ...
  validAttributes:push_back{
    nmx.String.new('Body group Attributes'),
...
callbackManager:unRegisterAttributeGroupsCallback(nmx.BodyGroupNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.BodyGroupNode.ClassTypeId(), attributeGroups)
