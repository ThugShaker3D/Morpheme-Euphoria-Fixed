...
------------------------------------------------------------------------------------------------------------------------
registerNode("LastFramesTransforms",
  {
    helptext = "Outputs the last transformation state of the system",
    group = "Utilities",
    image = "LastFramesTransforms.png",
    -- LastFramesTransforms node uses the FreezeNodeBuilder in the asset compiler because these nodes are identical apart
    -- apart from one attribute - passThroughTransformsOnce
    ...
    serialize = function(node, Stream)
      Stream:writeBool(false, "passThroughTransformsOnce")
    end,
