...
local attributeGroups, errorString = scriptManager:createCallback(
  ...
  -- The camera does not display any of its attributes.
  --
  [[]]
)

-- Unregister any previous callbacks
callbackManager:unRegisterAttributeGroupsCallback(nmx.CameraNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.CameraNode.ClassTypeId(), attributeGroups)
