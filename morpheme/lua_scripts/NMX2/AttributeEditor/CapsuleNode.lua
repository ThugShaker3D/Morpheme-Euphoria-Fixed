...
local attributeGroups, errorString = scriptManager:createCallback(
  ...
  [[
    validAttributes:push_back{
      nmx.String.new('Capsule Attributes'),
      nmx.String.new('Height'),
      nmx.String.new('Radius') }
  ]]
)

-- Unregister any previous callbacks
callbackManager:unRegisterAttributeGroupsCallback(nmx.CapsuleNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.CapsuleNode.ClassTypeId(), attributeGroups)
