...
local attributeGroups, errorString = scriptManager:createCallback(
  ...
  validAttributes:push_back{
    nmx.String.new('Instance Settings'),
    nmx.String.new('Visible') }
  ]]
)

-- Unregister any previous callbacks
callbackManager:unRegisterAttributeGroupsCallback(nmx.sgShapeNode.ClassTypeId())
-- Register the new callback
callbackManager:registerAttributeGroupsCallback(nmx.sgShapeNode.ClassTypeId(), attributeGroups)