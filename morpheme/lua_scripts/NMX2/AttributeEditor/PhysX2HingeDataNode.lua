...
local hingeDataAttributeGroups = scriptManager:createCallback(
  ...
  [[
    local attrs = {
      'PhysX2 Limit Attributes',
      'DriveSpring',
      'DriveDamping',
      'DriveSpringIsAcceleration',
    }
...
callbackManager:unRegisterAttributeGroupsCallback("PhysX2HingeBodyNode")
-- Register the new callback
callbackManager:registerAttributeGroupsCallback("PhysX2HingeBodyNode", hingeDataAttributeGroups)